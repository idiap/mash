...
namespace Mash
{
    ...
    /// @brief  The type
    //--------------------------------------------------------------------------
    enum tGoalPlanningMode
    {
        GPMODE_STANDARD,                ///< Full interaction with the task
        GPMODE_TEACHER,                 ///< GPMODE_STANDARD + teacher actions are available
        GPMODE_RECORDED_TEACHER,        ///< Prerecorded trajectories with teacher actions
        GPMODE_RECORDED_TRAJECTORIES,   ///< Prerecorded trajectories
