...
/** @file   classifier_input_set_listener.h
    ...
    Declaration of the 'ClassifierInputSetListener' class
*/

#ifndef _MASH_CLASSIFIERINPUTSETLISTENER_H_
#define _MASH_CLASSIFIERINPUTSETLISTENER_H_
...
namespace Mash
{
    ...
    //--------------------------------------------------------------------------
    class MASH_SYMBOL ClassifierInputSetListener: public IClassifierInputSetListener
    {
    ...
    public:
        ...
        /// @brief  Destructor
        //----------------------------------------------------------------------
        virtual ~ClassifierInputSetListener()
        {
        }
    ...
    public:
                                        ...
                                        scalar_t* values)
        {
            ...
            pInstrumentsSet->onFeaturesComputedByClassifier(detection, training,
