...
//------------------------------------------------------------------------------
/// @file MLClassifiers/AdaBoost.MH.h
/// @author Charles Dubout (charles.dubout@idiap.ch)
/// @date 2010.02.09
/// @version 2.2
//------------------------------------------------------------------------------

#ifndef ML_CLASSIFIERS_ADABOOST_MH_H
#define ML_CLASSIFIERS_ADABOOST_MH_H
...
namespace ML {
	...
	private:
		...
		public:
			...
			/// @retval	distr		The predicted class memberships
			//------------------------------------------------------------------
			void distribution(InputSet& inputSet,
							  unsigned int sample,
							  char* distr) const;
...
#endif // ML_CLASSIFIERIS_ADABOOST_MH_H
