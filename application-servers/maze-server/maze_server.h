...
/** @file   maze_server.h
    ...
    Declaration of the 'MazeServer' class
*/

#ifndef _MAZE_SERVER_H_
#define _MAZE_SERVER_H_
...
//------------------------------------------------------------------------------
/// @brief Concrete implementation of the Maze Server
//------------------------------------------------------------------------------
class MazeServer: public Mash::IApplicationServer
{
...
protected:
    enum tRandomNumberGenerator
    {
        RND_GOAL,
        RND_ENVIRONMENT,
        
        COUNT_RANDOM_NUMBER_GENERATORS
    };
...
protected:
    World*                      _world;
    Mash::RandomNumberGenerator _randomGenerators[COUNT_RANDOM_NUMBER_GENERATORS];
};
