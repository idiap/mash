...
//------------------------------------------------------------------------------
class rgb_hosplushist: public Heuristic
{
    //_____ Construction / Destruction __________
public:
    rgb_hosplushist();
    virtual ~rgb_hosplushist();
...
rgb_hosplushist::rgb_hosplushist()
{
...
unsigned int rgb_hosplushist::dim()
{
...
void rgb_hosplushist::prepareForCoordinates()
{
...
void rgb_hosplushist::finishForCoordinates()
{
   delete[] dth_des;
}


scalar_t rgb_hosplushist::computeFeature(unsigned int feature_index)
{
