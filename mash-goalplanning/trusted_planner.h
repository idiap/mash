...
/** @file   trusted_planner.h
    @author Philip Abbet (philip.abbet@idiap.ch)

    Declaration of the 'TrustedPlanner' class
*/

#ifndef _MASH_TRUSTEDPLANNER_H_
#define _MASH_TRUSTEDPLANNER_H_
...
{
    //--------------------------------------------------------------------------
    /// @brief  Represents a trusted goal-planner
    //--------------------------------------------------------------------------
    class MASH_SYMBOL TrustedPlanner: public IPlannerDelegate
    {
    ...
    public:
        ...
        /// @brief  Destructor
        //----------------------------------------------------------------------
        virtual ~TrustedPlanner();


        //_____ Management __________
    public:
        //----------------------------------------------------------------------
        /// @brief  Configure the trusted goal-planner
        ///
    ...
    protected:
        PlannersManager*    _pManager;          ///< The goal-planners manager used
        Planner*            _pPlanner;          ///< The goal-planner
