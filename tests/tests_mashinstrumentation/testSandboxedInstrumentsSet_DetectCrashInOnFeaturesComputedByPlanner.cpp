...
int main(int argc, char** argv)
{
    ...
    CHECK_EQUAL(0, sandbox.loadInstrumentPlugin("unittests/crash_in_onfeaturescomputedbyplanner"));
    ...
    CHECK(!sandbox.onFeaturesComputedByPlanner(0, 0, 0, position, 63, 0, 1, &index, &feature));
