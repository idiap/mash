...
server = subprocess.Popen(server_path.split(), stdout=subprocess.PIPE, stderr=subprocess.STDOUT, cwd=cwd)

time.sleep(1)

# Start the client application
client = subprocess.Popen(client_path.split(), stdout=subprocess.PIPE, stderr=subprocess.STDOUT, cwd=cwd)
