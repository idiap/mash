...
int main(int argc, char** argv)
{
    ...
    // This heuristic will crash in prepareForImage() if it succeeds at executing something
    CHECK_EQUAL(0, sandbox.loadHeuristicPlugin("unittests/commandexecution"));
