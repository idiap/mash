...
int main(int argc, char** argv)
{
    ...
    // This heuristic will crash in prepareForImage() if it succeeds at loading a dynamic library
    CHECK_EQUAL(0, sandbox.loadHeuristicPlugin("unittests/dynlibloading"));
